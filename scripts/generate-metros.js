...
const METRO_LOCAL = {
  ...
  'san-francisco-ca': [
    'San Francisco has the mildest, most stable smoking weather of any major US city, and the season essentially never closes. The marine climate keeps highs moderate year-round — rarely hot, rarely freezing — with moderate dew points and a mostly rain-free stretch from spring through fall. The wettest months are December through March, but even then cookable weekends are common. The one constant is the afternoon wind and fog off the Pacific, which is the real variable a Bay Area pitmaster plans around rather than heat or storms.',
