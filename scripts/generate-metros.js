...
const METRO_LOCAL = {
  ...
  'milwaukee-wi': [
    'Milwaukee’s weather is a Lake Michigan story. The lake keeps spring cool and lingering, moderates summer heat while feeding humidity, and drives gray, cold, snowy winters that run long. Summers are warm and pleasant with the occasional severe storm rolling in off the plains to the west, and the lake breeze can swing a shoreline afternoon’s temperature in a hurry. The most dependable cooking comes from late spring through early fall, with the shoulder weeks calmest and the deep winter best left to insulated rigs.',
  ...
  'jacksonville-fl': [
    'Jacksonville sits in northeast Florida, in genuinely humid subtropical climate rather than the tropical far south of the state. Summers are hot and sticky, with high dew points and near-daily afternoon thunderstorms from June through September, and the metro sits squarely in the Atlantic and Gulf storm tracks through hurricane season. The payoff comes on the other end: October through April runs warm, drier, and reliably cookable, with winter rarely cold enough to stop a cook.',
  ...
  'richmond-va': [
    ...
    'Summer humidity stretches the stall, so the long cuts want extra time and a wrap from June onward. An insulated cooker — kamado or pellet — carries the humid summer and the damp, gusty winter weeks with less fuss than an open firebox. Richmond’s tradition centers on Virginia-style chopped pork, a sweeter tomato-and-vinegar take that bridges Carolina and the Mid-Atlantic, with brisket houses now adding to the menu. Run the long sessions on the calm, clear days the score flags, and let pork and ribs cover the unsettled summer Saturdays.',
  ],
  'louisville-ky': [
