...
const METRO_LOCAL = {
  ...
  'tampa-fl': [
    'Tampa Bay sits on Florida’s Gulf Coast and runs the state’s classic two-season rhythm. The dry season — October through May — is the prime smoking stretch: warm, breezy, lower humidity, and weekend after weekend of cookable weather. From June through September the wet season takes over, and the bay area is one of the most lightning-prone corners of the country, with thunderstorms firing nearly every afternoon. Gulf hurricane season overlaps that stretch from June into November, so a long-range summer cook needs a backup plan.',
    'The summer humidity drives a high wet-bulb temperature, which means brisket and pork-butt stalls run long and stubborn through the wet months. A sealed kamado earns its keep here, holding an efficient stall and sipping fuel in the mugginess; a pellet cooker manages it without fuss. Tampa’s pits blend Carolina pork with strong Latin and Cuban influence, and citrus-and-mojo pork suits the climate. Cook early to beat the afternoon storm clock, give long cuts extra time in the humidity, and treat the October-to-May dry season as your main event.',
  ],
  'denver-co': [
  ...
  'charlotte-nc': [
    'Charlotte sits in the Carolina Piedmont, where humid subtropical summers meet mild, workable winters. The long shoulder seasons are the prize — March into May and September into November bring comfortable highs and dew points well below the swampy midsummer peak. June through August is hot and humid with near-daily afternoon thunderstorms, so summer cooks live by the radar. Winters stay mild enough that cookable weekends show up all year, and hard freezes are brief.',
  ...
  'orlando-fl': [
    'Orlando sits inland in Central Florida, in the stretch nicknamed Lightning Alley for good reason. From June through September, sea breezes off both coasts collide over the peninsula’s middle and fire daily afternoon thunderstorms — often violent, usually between two and six o’clock. The flip side is the dry season, October through May, which is warm, lower-humidity, and reliably cookable weekend to weekend. Hurricane season runs June into November, and even an inland metro feels the bigger systems, so summer plans need flexibility.',
  ...
  'portland-or': [
    'Portland’s smoke season is a tale of two halves. The dry window — roughly July through September — is glorious: warm, rain-free, low-humidity weekends that rank among the best cooking weather in the country. The other nine months are the Pacific Northwest’s signature damp, a cool, gray drizzle that runs October into June. It rarely freezes hard, but the persistent moisture — not cold or wind — is the variable that shapes a Portland cook.',
  ...
  'cincinnati-oh': [
    ...
    'Valley humidity through the summer keeps the wet-bulb temperature up and the stall long, so plan extra time for brisket and pork from June onward and keep a wrap within reach. Through the cold, damp winter and the unsettled shoulder weeks, a sealed kamado or pellet cooker holds a far steadier fire than an exposed offset. Cincinnati’s German roots run through its smoke as much as its kitchens — bratwurst and smoked sausage share the pit with the regional pulled pork and ribs — and sausage is a quick, weather-tolerant cook for an iffy Saturday. Save the all-day briskets for the calm, dry windows the score flags green.',
  ],
  'kansas-city-mo': [
    ...
    'Gust speed decides more KC Saturdays than rain or cold, so the wind forecast is the first thing to check before a long cook. The offset stick burner — still the regional standard — wants a solid wind break and heavier woods like hickory and oak that carry smoke through a long, humid-summer stall; a pellet rig or kamado is the steadier choice on blustery days. Kansas City gave barbecue its burnt ends, the caramelized cubes off a brisket point, which means cooking the packer well past the stall and rewarding patience. Time those long cooks for the low-wind windows the score flags, and let the insulated cooker handle the gusty ones.',
  ],
  'columbus-oh': [
  ...
  'cleveland-oh': [
    ...
    'Lake-driven humidity keeps summer stalls long, so give brisket and pork the extra hours and keep a wrap ready. The long, snowy winter is the real limiter — a sealed kamado or pellet rig is the only practical way to keep smoking from December through February, holding heat the lake wind would strip from an open pit. Cleveland’s Eastern European roots put kielbasa and smoked sausage on the pit beside the regional pulled pork and ribs, and sausage is a fast, forgiving cook for a marginal day. Track the lake-effect bands in winter, lean on the insulated cooker through the cold, and save the long cooks for calm summer and shoulder Saturdays.',
  ],
  'austin-tx': [
