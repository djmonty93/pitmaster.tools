...
const METRO_HERITAGE = {
  ...
  'las-vegas-nv': 'Las Vegas has no native barbecue tradition, but the hospitality economy has made it an unusual market. Major Texas, Kansas City, and Memphis-style operations run alongside casino food halls, drawing on the same restaurant labor pool as the Strip. What Vegas lacks in regional identity it makes up for in variety: nearly every significant American smoke style is represented within a few miles, and competition for diners is fiercer than a smaller city could sustain.',
