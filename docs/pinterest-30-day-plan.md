# Pinterest 30-Day Launch Plan — July 17 → August 15, 2026
...
All 30 pins are photorealistic creatives committed at `og/pins/<dNN-slug>.jpg`
(1000×1500 at 2x, JPEG) and served at
`https://pitmaster.tools/og/pins/<dNN-slug>.jpg` once deployed — these are the
Media URLs in `docs/pinterest-30-day-pins.csv`. Each is an AI-generated
photographic background (image-router MCP, FLUX Pro) composited under the
Pitmaster brand overlay: headline, accent line, CTA pill and footer are drawn
in real fonts over a dark gradient scrim, never baked into the photo. Rebuild
the overlays with `node scripts/render-campaign-pins.mjs` (a **local/offline
dev step only** — never in build or deploy); it reads source photos from
`pin-src/<dNN-slug>.jpg`, a local dir that is **not** under `og/`, so build
never ships the raw sources. The per-pin "Prompt" lines in the schedule below
were the original creative briefs and are kept for context.

---

## 4. The 30-day schedule

### Week 1 — Jul 17–23 · launch the core cheat sheets (existing images)

**Day 1 · Fri Jul 17 · 8:30 PM · Smoked Brisket**
- Link: `/brisket-calculator` `?pin30&utm_content=d01-brisket`
- Image: `og/pins/d01-brisket.jpg`
...
**Day 2 · Sat Jul 18 · 2:00 PM · Ribs & Pulled Pork**
- Link: `/rib-calculator` `?pin30&utm_content=d02-ribs`
- Image: `og/pins/d02-ribs.jpg`
...
**Day 3 · Sun Jul 19 · 2:00 PM · Ribs & Pulled Pork**
- Link: `/pork-shoulder-calculator` `?pin30&utm_content=d03-porkbutt`
- Image: `og/pins/d03-porkbutt.jpg`
...
**Day 4 · Mon Jul 20 · 8:30 PM · BBQ Calculators & Cheat Sheets**
- Link: `/smoking-times-and-temps` `?pin30&utm_content=d04-chart`
- Image: `og/pins/d04-chart.jpg`
...
**Day 5 · Tue Jul 21 · 8:30 PM · BBQ for a Crowd**
- Link: `/meat-per-person` `?pin30&utm_content=d05-meatpp`
- Image: `og/pins/d05-meatpp.jpg`
...
**Day 6 · Wed Jul 22 · 8:30 PM · BBQ for a Crowd**
- Link: `/cook-time-coordinator` `?pin30&utm_content=d06-coordinator`
- Image: `og/pins/d06-coordinator.jpg`
...
**Day 7 · Thu Jul 23 · 8:30 PM · BBQ Calculators & Cheat Sheets**
- Link: `/charcoal-calculator` `?pin30&utm_content=d07-charcoal`
- Image: `og/pins/d07-charcoal.jpg`
...
### Week 2 — Jul 24–30 · finish the tool set + first secondary page

**Day 8 · Fri Jul 24 · 8:30 PM · BBQ Calculators & Cheat Sheets**
- Link: `/dry-rub-calculator` `?pin30&utm_content=d08-rub`
- Image: `og/pins/d08-rub.jpg`
...
**Day 9 · Sat Jul 25 · 2:00 PM · BBQ for a Crowd**
- Link: `/catering-calculator` `?pin30&utm_content=d09-catering`
- Image: `og/pins/d09-catering.jpg`
...
**Day 10 · Sun Jul 26 · 2:00 PM · BBQ Calculators & Cheat Sheets**
- Link: `/brine-calculator` `?pin30&utm_content=d10-brine`
- Image: `og/pins/d10-brine.jpg`
...
**Day 11 · Mon Jul 27 · 8:30 PM · BBQ for a Crowd**
- Link: `/bbq-cost-calculator` `?pin30&utm_content=d11-cost`
- Image: `og/pins/d11-cost.jpg`
...
**Day 12 · Tue Jul 28 · 8:30 PM · Smoked Brisket**
- Link: `/brisket-yield-calculator` `?pin30&utm_content=d12-yield`
- Image: `og/pins/d12-yield.jpg`
...
**Day 13 · Wed Jul 29 · 8:30 PM · Smoking Weather & Seasons** *(secondary page)*
...
**Day 14 · Thu Jul 30 · 8:30 PM · BBQ Calculators & Cheat Sheets**
- Link: `/turkey-smoking-calculator` `?pin30&utm_content=d14-turkey`
- Image: `og/pins/d14-turkey.jpg`
...
### Week 3 — Jul 31–Aug 6 · second angles, fresh photo creatives

**Day 15 · Fri Jul 31 · 8:30 PM · Smoked Brisket**
...
**Day 16 · Sat Aug 1 · 2:00 PM · BBQ for a Crowd**
...
- Description: `20 guests ≈ 10 lb of cooked meat ≈ 20 lb raw — but the split changes if you're serving ribs vs pulled pork vs brisket. Free calculator: enter your headcount and menu, get a shopping list. Peak cookout season, handled.`

**Day 17 · Sun Aug 2 · 2:00 PM · Ribs & Pulled Pork**
...
**Day 18 · Mon Aug 3 · 8:30 PM · Smoked Brisket** *(secondary page)*
...
**Day 19 · Tue Aug 4 · 8:30 PM · BBQ Calculators & Cheat Sheets**
...
**Day 20 · Wed Aug 5 · 8:30 PM · BBQ for a Crowd**
...
**Day 21 · Thu Aug 6 · 8:30 PM · Smoking Weather & Seasons** *(secondary page)*
...
- Description: `Hot days mean faster starts, thirstier water pans, and afternoon thunderstorms that ambush your fire. Our summer guide covers how heat and humidity change your smoke — plus which days this week actually forecast well. Peak grilling season; smoke accordingly.`

### Week 4 — Aug 7–13 · second angles continued

**Day 22 · Fri Aug 7 · 8:30 PM · Ribs & Pulled Pork**
...
**Day 23 · Sat Aug 8 · 2:00 PM · BBQ for a Crowd**
...
**Day 24 · Sun Aug 9 · 2:00 PM · BBQ Calculators & Cheat Sheets**
...
**Day 25 · Mon Aug 10 · 8:30 PM · Smoking Weather & Seasons** *(secondary page)*
...
**Day 26 · Tue Aug 11 · 8:30 PM · BBQ Calculators & Cheat Sheets**
...
**Day 27 · Wed Aug 12 · 8:30 PM · BBQ Calculators & Cheat Sheets**
...
**Day 28 · Thu Aug 13 · 8:30 PM · BBQ for a Crowd**
...
### Days 29–30 — Aug 14–15 · roundup + top-performer reinforcement

**Day 29 · Fri Aug 14 · 8:30 PM · BBQ Calculators & Cheat Sheets** *(secondary page)*
...
**Day 30 · Sat Aug 15 · 2:00 PM · Smoked Brisket**
...
- Seasonal pipeline for month 2 (Aug 16+): tailgate/football prep (cook-time coordinator, catering), Labor Day (Sep 7) countdown pins for brisket + meat-per-person, and the turkey calculator ramp starting late September.
